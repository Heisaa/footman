...
SKULL = [
    ...
    # is a rounded *box* at the jaw and rounder through the cranium. The face
    # rows sat at 3.2 to 4.2 for a while, and at that power the front of a ring
    # is a plane: the whole face was one flat wall from the game's angle. They
    # are 2.2 to 2.4 now, the cranium 2.1, and `bulge` carries a third more to keep the muzzle
    # that the box used to give for free.
    #
    ...
    (0.632, 0.595, -0.145, 2.0, 0.660, 0.010, 0.012),
    (0.650, 0.705, -0.145, 2.2, 0.760, 0.040, 0.032),
    (0.670, 0.843, -0.105, 2.4, 0.865, 0.065, 0.024),
    (0.682, 0.894, -0.081, 2.4, 0.899, 0.078, -0.020),
    (0.695, 0.949, -0.055, 2.4, 0.935, 0.094, 0.032),
    (0.708, 0.976, -0.045, 2.35, 0.958, 0.107, -0.010),
    (0.720, 1.000, -0.035, 2.3, 0.980, 0.117, 0.044),
    (0.734, 1.010, -0.027, 2.25, 0.997, 0.114, 0.010),
    (0.745, 1.018, -0.021, 2.2, 1.011, 0.107, 0.004),
    (0.775, 1.014, -0.003, 2.15, 1.011, 0.075, 0.000),
    (0.805, 1.000, 0.006, 2.1, 1.007, 0.042, 0.000),
    (0.835, 0.998, 0.007, 2.1, 0.999, 0.017, 0.000),
    (0.862, 0.967, 0.015, 2.1, 0.967, 0.004, 0.000),
    (0.885, 0.909, 0.011, 2.1, 0.909, 0.000, 0.000),
    (0.905, 0.829, 0.006, 2.15, 0.829, 0.000, 0.000),
    (0.921, 0.738, 0.003, 2.2, 0.738, 0.000, 0.000),
    (0.934, 0.636, 0.000, 2.3, 0.636, 0.000, 0.000),
    (0.944, 0.526, 0.000, 2.5, 0.526, 0.000, 0.000),
    (0.951, 0.414, 0.000, 2.8, 0.414, 0.000, 0.000),
